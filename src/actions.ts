import { ActionConfig, HomeAssistant, NumberPickerCardConfig } from './types';
...
export function bindActionHandler(
  el: HTMLElement,
  getContext: () => { hass: HomeAssistant; config: NumberPickerCardConfig }
): void {
